...
public class Posters {
    ...
    public Posters(TeamManager teamManager) {
        ...
        NPC generalPoster = new NPC(teamManager, "General Poster", GENERAL_POSTER);
        generalPoster.setDefaultHandler(event -> {
        ...
        NPC fungalPoster = new NPC(teamManager, "Fungal Poster", FUNGAL_RECKONING_POSTER);
        fungalPoster.setDefaultHandler(event -> {
            Player player = event.getPlayer();
        ...
        NPC witheringPoster = new NPC(teamManager, "Withering Groove", WITHERING_GROOVE_POSTER);
        witheringPoster.setDefaultHandler(event -> {
            Player player = event.getPlayer();
