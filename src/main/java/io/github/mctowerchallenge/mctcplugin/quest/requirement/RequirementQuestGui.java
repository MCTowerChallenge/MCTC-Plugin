package io.github.mctowerchallenge.mctcplugin.quest.requirement;
...
public class RequirementQuestGui extends QuestGui {
    ...
    public RequirementQuestGui(MCTCPlugin plugin, String name, @Nullable String body, List<? extends Requirement> requirements) {
