...
public class PortalFrameConfig {
     ...
     */
    public PortalFrameConfig(Plugin plugin) throws IOException {
        config = ConfigUtils.initConfigFile(plugin, "portal_frames.yml");
    }
    ...
    private @Nullable Section getConfigSection() {
        ...
        return config.getSection("portalframes");
    }
