...
public class TrackedStatsGUI extends ListGui {
     ...
     */
    public TrackedStatsGUI(MCTCPlugin plugin, TeamManager teamManager, Element exitElement) {
    ...
    public class TrackedStatElement extends ButtonElement {
         ...
         * the stat for all players
         */
        public TrackedStatElement(MCTCPlugin plugin, TeamManager teamManager, ItemStack icon, AbstractStatistic... statistics) {
