package io.github.mctowerchallenge.mctcplugin.decoration.waterspouts;
...
//        new ConstantSpout(new Location(Worlds.Feb2023(), 102.5, 65, -2118.5), height).runSpout();
        ...
        for (Spout spout : spouts) {
            count++;
            Bukkit.getScheduler().scheduleSyncDelayedTask(MCTCPlugin.getInstance(), spout::runSpout, count * 20L * 5);
        }
